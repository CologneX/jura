...
class UserService extends ChangeNotifier {
  ...
  UserService({FlutterSecureStorage? secureStorage})
  ...
  Future<void> init() async {
    ...
    try {
      ...
      if (userId != null) {
        ...
        final primaryCurrency = await _secureStorage.read(key: storageKeyPrimaryCurrency);
        final isPremiumStr = await _secureStorage.read(key: storageKeyIsPremium);

        if (username != null && primaryCurrency != null && isPremiumStr != null) {
          _currentUser = User(
            id: userId,
            username: username,
  ...
  /// Update specific user property (e.g., after currency change)
  ...
  Future<void> updateCurrency(String currency) async {
    try {
      ...
      updateUserProperty(primaryCurrency: currency);
    } catch (e) {
