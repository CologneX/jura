...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiaryFixedDim: Color(0xffebb8cf),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff534e87),
      ...
      tertiaryFixedDim: Color(0xff70495c),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xffb28499),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffc2bbfc),
      ...
      tertiaryContainer: Color(0xffe7b5cb),
      ...
      primaryFixedDim: Color(0xffc6bfff),
      onPrimaryFixedVariant: Color(0xff0e053f),
      secondaryFixed: Color(0xffe4dff9),
